...
| 3   | [Frota de Subagentes](./03-frota-subagentes.md)                 | Agentes especializados (incluindo DevOps e Dados Sintéticos) |
| 4   | [Hooks de Segurança](./04-hooks-seguranca.md)                   | Scripts que interceptam e bloqueiam comandos perigosos       |
| 5   | [Orquestração Prática](./05-orquestracao-pratica.md)            | Como comandar a frota usando TDD no dia a dia                |
...
```
arquivos/SPEC.md                   → docs/SPEC.md (Template de Especificação)
...
arquivos/data-synthesizer.md       → .claude/agents/data-synthesizer.md
arquivos/cloud-architect.md        → .claude/agents/cloud-architect.md
